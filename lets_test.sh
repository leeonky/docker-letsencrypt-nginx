...
test_obtain_cert_call_certbot_with_right_args() {
	cat > $CONF_PATH/www.baidu.com.https <<EOF
	server_name www.b.com www.baidu.com;
EOF
	...
	mock_verify certbot HAS_CALLED_WITH certonly --webroot -w /var/www-lets/letsencrypt -m leeonky@gmail.com --cert-name www.baidu.com --agree-tos --non-interactive --expand -d www.b.com -d www.baidu.com
}
